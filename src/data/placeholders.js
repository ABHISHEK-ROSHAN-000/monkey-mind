...
export const PROJECTS = [
  ...
  { ...framerProject('p-goon', 'Goon Squad', 'goon-squad', CDN.yellow, [CDN.yellow, img('mm-engine9', 1200, 900)], { categoryIds: ['ad-marketing'], excerpt: 'Campaign + motion placeholders.', body: 'Placeholder body for Goon Squad.', year: '2024', tags: ['Campaign'], featured: true, featuredOrder: 3, order: 3 }) },
